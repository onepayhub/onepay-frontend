...
const HeroSection = () => {
  return (
    <div className="bg-[#eee] relative px-10 rounded-[20px] py-10 mt-20 container mx-auto container-md">
      <img
        src={image2}
        alt="image"
        className="absolute w-[70px] lg:w-[100px] bottom-[30%]"
      />
      <img
        src={image6}
        alt="image"
      ...
      <img
        src={image7}
        alt="image"
        className="absolute w-[70px] lg:w-[100px] left-[11%] bottom-[7%]"
      />
      <img
        src={image9}
        alt="image"
      ...
      <img
        src={image5}
        alt="image"
        className="absolute w-[70px] lg:w-[100px] bottom-[3%] right-[1%]"
      />
      <img
        src={image4}
        alt="image"
        className="absolute w-[70px] lg:w-[100px] bottom-[30%] right-[5%]"
      />
