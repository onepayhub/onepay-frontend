      ...
      <div className="w-full flex-col gap-y-6 hidden md:flex">
        ...
        <div className="mr-3 flex flex-col gap-y-8 px-2">
          ...
          <span
            ...
            className="mx-auto text-primary hidden mt-8  font-medium lg:flex w-full items-center gap-x-3 rounded-[5px] px-3 py-4 transition-all ease-in hover:cursor-pointer hover:bg-primary hover:bg-opacity-20"
          >
            <IoMdLogOut size={23} />
            Log out
          </span>
